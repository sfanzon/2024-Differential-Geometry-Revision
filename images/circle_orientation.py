...
def update(frame):
    ...
    x_curve1 = np.cos(t_values1)
    y_curve1 = np.sin(t_values1)
    ...
    x_curve2 = np.cos(-t_values2)
    y_curve2 = np.sin(-t_values2)
...
ani.save('circle_orientation.gif', writer='pillow', fps=30)
